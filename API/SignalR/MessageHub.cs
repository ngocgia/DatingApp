...
namespace API.SignalR
{
    ...
    public async Task SendMesage(CreateMessageDto createMessageDto)
    {
    ...
    {
        var group = await _messageRepository.GetMessageGroup(groupName);
        var connecttion = new Connection(Context.ConnectionId, Context.User.GetUsername());
        ...
        group.Connections.Add(connecttion);
        return await _messageRepository.SaveAllAsync();
    }

    private async Task RemoveFromMessageGroup(string connectionId)
    {
        var connecttion = await _messageRepository.GetConnection(connectionId);
        _messageRepository.RemoveConnection(connecttion);
